...
public class DateU {
    ...
    public static String getCurrentTimeBeforeMinute(int n){
        Calendar beforeTime = Calendar.getInstance();
        beforeTime.add(Calendar.MINUTE, -n);
        return new SimpleDateFormat(FORMAT).format(beforeTime.getTime());
    }
    public static String getCurrentTimeBeforeSecond(int n){
        Calendar beforeTime = Calendar.getInstance();
        beforeTime.add(Calendar.SECOND, -n);
        return new SimpleDateFormat(FORMAT).format(beforeTime.getTime());
    }
    ...
    public static long minuteTime(String time,Locale locale,String parsePatterns) throws ParseException {
        return DateUtils.parseDate(time, locale, parsePatterns).getTime();
    }


    public static long minuteBeginTime(long time) {
    ...
    public static List<String> checkRepeatDate(String strDate) throws ParseException {
        ...
        for (String aTempStrDate : tempStrDate) {
            HashMap<String, String> dateMap = new HashMap<String, String>();
            dateMap = formatStrDateToDateMap(aTempStrDate);
            if (dateMap == null)
                continue;
