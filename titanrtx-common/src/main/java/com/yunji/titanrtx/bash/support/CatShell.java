 ...
 *
 */
public class CatShell extends AbstractShell {

    private static final String COMMANDER = "cat";

    public CatShell(String options,String arguments) {
    ...
    public List<String> hosts() throws IOException {
        ...
        return Arrays.asList(execCommand().split("\n"));
    }
